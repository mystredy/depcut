...
@MainActor
protocol DepCutUpdateChecking: AnyObject {
    var currentVersion: String { get }
    var updateStateChanged: ((DepCutUpdateState) -> Void)? { get set }
...
@MainActor
final class SparkleUpdateController: NSObject, DepCutUpdateChecking, SPUUserDriver {
    ...
    var updateStateChanged: ((DepCutUpdateState) -> Void)?
