...
const navItems = [
  { href: "/depcutvision/settings/usage", label: "Usage" },
  { href: "/depcutvision/settings/api-keys", label: "API keys" },
];

// The DepCut Vision settings: API keys and usage for the Vision API. DepCut
  ...
  useEffect(() => {
    if (!isPending && !session) {
      void authClient.signIn.social({
        callbackURL: "/depcutvision/settings",
        provider: "google",
      });
    }
  }, [isPending, session]);
    ...
    <div className="min-h-screen">
      <header className="border-b">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
          <Link className="flex items-center gap-2 text-lg font-semibold" href="/depcutvision">
