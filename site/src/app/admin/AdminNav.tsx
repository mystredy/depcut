...
const SECTIONS: NavSection[] = [
  ...
  { kind: "leaf", id: "announcements", label: "Announcements", icon: Megaphone, color: "text-amber-500", href: "/admin/announcements" },
  {
    ...
    children: [
      { label: "Posts", href: "/admin/blog", icon: Newspaper, color: "text-orange-500" },
      { label: "Stats", href: soon("Blog — Stats"), icon: LineChart, color: "text-emerald-500" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "AI Pricing", href: "/admin/finance/ai-pricing", icon: LineChart, color: "text-lime-500" },
