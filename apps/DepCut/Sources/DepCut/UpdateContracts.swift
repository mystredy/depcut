...
/// produces it.
public enum DepCutUpdateStatus: String, Equatable, Sendable {
    case notChecked
    case checking
    case upToDate
    case available
...
public struct DepCutUpdateState: Equatable, Sendable {
    public var status: DepCutUpdateStatus
    public var currentVersion: String
    public var latestVersion: String?
    public var message: String?

    public init(
        status: DepCutUpdateStatus = .notChecked,
