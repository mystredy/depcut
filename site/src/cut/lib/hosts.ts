...
export const CUT_MEDIA_HOST = process.env.CUT_MEDIA_HOST || "media.depcut.app";
...
export const CUT_WORKER_HOST = process.env.CUT_WORKER_HOST || "worker.depcut.app";
...
// "/…" → "/cut/…" mapping as depcut.app (see src/proxy.ts).
