...
/// DepCut is a menu bar app with no windows and no account. The product is the DepCut video editor
...
@MainActor
final class DepCutAppDelegate: NSObject, NSApplicationDelegate, NSMenuDelegate {
    /// The menu bar surface: the status item whose menu carries Go to App, Record Screen, updates, and Quit.
    private var statusItemController: DepCutStatusItemController?
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        let cutEngineSupervisor = DepCutEngineSupervisor()
    ...
    private func installStatusItem() {
        statusItemController = DepCutStatusItemController(
