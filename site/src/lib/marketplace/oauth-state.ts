...
type StatePayload = {
  ...
  // pool (default) or a specific studio's Repurpose panel. The callback
  // route reads this to pick which permission check applies and which
  // owner field to set on the resulting SocialConnection.
