...
import { VisionCompareSlider } from "@/app/depcutvision/VisionCompareSlider";
import { VISION_DATASETS } from "@/app/depcutvision/visionData";
...
export function VisionCompareSection() {
  ...
  return (
    <section
      id="demo"
      className="border-y-2 border-[#0F0E0D] bg-[#E6F4FC] py-20"
    >
