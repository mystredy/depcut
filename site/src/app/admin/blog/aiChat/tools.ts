...
// body, and now excerpt/tags too), nothing more:
...
export type BlogAiToolName = "set_title" | "set_excerpt" | "set_tags" | "update_content";
...
// dirty/autosave path a manual edit does.
