...
const INSTRUCTIONS = [
  ...
  "only reads the video, it doesn't change the post. Call list_skills before",
  "working on a recurring editorial pattern you're unsure about — an admin",
  "may have written a playbook for it at /admin/ai/skills; read_skill pulls",
  "one's full instructions by name. Use plain text only to",
