...
// first paint, so this route only renders what's underneath it. A signup
// lands here. New accounts no longer get an auto-seeded starter project (see
// signup-grants.ts), so this stays on the app home — the same thing that's
// behind the sequence everywhere else — for everyone except an account
// seeded before that change, which this still moves to its starter project's
// editor once the slides close.
